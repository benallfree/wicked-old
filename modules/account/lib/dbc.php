...
define ("DB_HOST", "internal-db.s126393.gridserver.com"); // set database host
define ("DB_USER", "db126393"); // set database user
define ("DB_PASS","ncapf98m4"); // set database password
define ("DB_NAME","db126393_singing"); // set database name
